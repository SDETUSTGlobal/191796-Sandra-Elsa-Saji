...
driver.find_element_by_css_selector("#ctl00_MainContent_fmwOrder_txtQuantity").send_keys("1500");
driver.find_element_by_id("ctl00_MainContent_fmwOrder_txtUnitPrice").send_keys("95");
driver.find_element_by_xpath("/html/body/form/table/tbody/tr/td[2]/div[2]/table/tbody/tr/td/ol[1]/li[5]/input[2]").click();
driver.find_element_by_name("ctl00$MainContent$fmwOrder$txtName").send_keys("Sandra")
driver.find_element_by_id("ctl00_MainContent_fmwOrder_TextBox2").send_keys("Chennithala")
driver.find_element_by_id("ctl00_MainContent_fmwOrder_TextBox3").send_keys("Mavelikara")
driver.find_element_by_id("ctl00_MainContent_fmwOrder_TextBox4").send_keys("Kerala")
driver.find_element_by_id("ctl00_MainContent_fmwOrder_TextBox5").send_keys("690104")
driver.find_element_by_id("ctl00_MainContent_fmwOrder_TextBox6").send_keys("123456789098")
driver.find_element_by_id("ctl00_MainContent_fmwOrder_TextBox1").send_keys("19/26")
driver.find_element_by_xpath("/html/body/form/table/tbody/tr/td[2]/div[2]/table/tbody/tr/td/ol[1]/li[5]/input[2]").click()
